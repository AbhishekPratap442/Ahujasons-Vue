<template>
        ...
        <div class="main_header">
                ...
                <div class="login">
                    ...
                    <div class="user_login">
                        <ul>
                            <li>
                                <a href="#">
                                    <img src="./img/user login.webp" alt />
                                </a>
                            </li>
                            <li>LOGIN &darr;</li>
                        </ul>
            ...
            <div class="left1">
                <ul>
                    <li>
                        <a href="#">
                            WOMEN
                            <img src="../assets/Path 115.png" alt />
                        </a>
                    </li>
                    <li>
                        <a href="#">
            ...
            <div class="mid">
                <img class="logo1" src="../assets/Group 195.png" />
                <img class="logo2" src="../assets/Group 2@2x.png" alt="ahujasons" />
            </div>
            <div class="right1">
                <div>
                    <ul>
